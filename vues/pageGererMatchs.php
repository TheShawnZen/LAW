...
<head>
	...
	<link href="<?php echo DOSSIER_BASE_LIENS;?>/css/gererMatchs_style.css" rel="stylesheet">
		...
		<div class='container-fluid'>
			...
			<div class="content">
				...
				<div class="tab">
							...
							<?php
								afficherListeMatchs($controleur->getTabMatchs());
							?>
				</div>
				<div class="saisie">
							<?php
								...
								include_once(DOSSIER_BASE_INCLUDE."vues/inclusions/formulaireGererMatch.inc.php");
							?>
					</div>
			</div>
